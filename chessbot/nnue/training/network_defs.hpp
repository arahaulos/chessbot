...
constexpr size_t num_perspective_neurons = 256;
constexpr size_t num_hidden_layer_neurons = 32;



constexpr int total_halfkp_outputs = 2*num_perspective_neurons;
...
constexpr int halfkp_quantization_fractions = 4096;
