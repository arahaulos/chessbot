...
int main()
{
    ...
    //nnue_trainer::train("netkb16d3_11.nnue", "qnetkb16d3_11.nnue", {"tuning/data6", "tuning/data7", "tuning/data8", "tuning/data9", "tuning/data10", "tuning/data11", "tuning/data12"});
    ...
    bot0->load_nnue_net("qnetkb16d3_10.nnue");
